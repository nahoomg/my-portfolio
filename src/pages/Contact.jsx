                ...
                >
                  {contactInfo.map((info, index) => (
                    <motion.a
                      ...
                      whileHover={{ x: 5 }}
                      className="flex items-center space-x-4 p-4 rounded-xl bg-white dark:bg-dark-card border border-gray-200 dark:border-dark-border hover:border-emerald-600 dark:hover:border-emerald-400 transition-all"
                    >
